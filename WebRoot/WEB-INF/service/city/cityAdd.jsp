...
<body>
	...
	<div class="container">
		...
		<div class="mainbox">
			<form id="form1" name="form1" action="saveAddCity.do" method="post"
				enctype="multipart/form-data">
				<input type="hidden" name="menuId" value="${menuId }" /> <input
					type="hidden" name="cityTaxi.struts" value="0" /> <input
					type="hidden" id="newC" value="0" /> <input id="cityName"
					type="hidden" name="cityTaxi.cityName" />
				<h3>手动增加区域</h3>
				<ul class="memlist fixwidth">
					<li><em><span style="color: red">*</span>适应区域：</em> <select
						id="province" onchange="getCity(this)"><option value="">请选择</option>
							<s:iterator value="sysProvince" var="um" status="index">
								<option value="{pid:${um.proId },name:'${um.proName }'}">${um.proName
									}</option>
							</s:iterator>
					</select><select id="city" onchange="getDistrict(this)"><option
								value="">请选择</option>
					</select><select id="district" onchange="isDistrict(this)"><option
								value="">请选择</option>
					...
					<li><em><span style="color: red">&nbsp;&nbsp;</span>适应公司:</em><input
						...
						onblur="isNew()" /><span id="companyNameError" style="color: red">为空则适应所选区域</span>
					</li>
					<li><em><span style="color: red">*</span>起步价:</em><input
						id="goNumber" name="cityTaxi.goNumber" maxlength="11" /><span
						id="goNumberError" style="color: red"></span></li>
					<li><em><span style="color: red">*</span>燃油附加费：</em><input
						id="extraNumber" name="cityTaxi.extraNumber" /><span
						id="extraNumberError" style="color: red"></span></li>
					<li><em><span style="color: red">*</span>每公里价格：</em><input
						id="gokmNumber" name="cityTaxi.gokmNumber" /><span
						id="gokmNumberError" style="color: red"></span></li>
					<li><em><span style="color: red">*</span>起步公里数：</em><input
						id="kmNumber" name="cityTaxi.kmNumber" /><span id="kmNumberError"
				...
				<div class="opt">
					...
					<input type="button" style="display: none" id="btn-submit"
						...
						href="inCityTaxi.do?menuId=${menuId}" target="_self"><span>返回</span>
					</a>
				</div>
