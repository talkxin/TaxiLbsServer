	...
	<div id="tabs1">
		<ul>
			...
			<s:if
				...
				<li><a href="addsDriver.do?menuId=${menuId }"><span>批量添加司机</span>
				</a>
				</li>
				<li id="current"><a href="#"><span>手动修改司机</span> </a>
				</li>
			...
			<form id="form1" name="form1" action="saveUpdateUser.do"
				...
				<ul class="memlist fixwidth">
					...
					<li><em><span style="color: red">*</span>登录名:</em><input
						...
						name="taxiUser.userName" id="userName" /></li>
				...
				<div class="opt">
					...
					<input type="button" style="display: none" id="btn-submit"
						...
						href="inUserInfo.do?menuId=${menuId}&pageNo=${pageNo}&seach[0]=${seach[0]}&seach[1]=${seach[1]}"
